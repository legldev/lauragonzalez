...
export default function Home() {
  ...
  function submitContact(event: FormEvent<HTMLFormElement>) {
    ...
    const message = [
      `Hola Laura, soy ${data.get('name')}.`,
      data.get('brand') ? `Mi marca/proyecto es ${data.get('brand')}.` : '',
      `${data.get('message')}`,
      `Mi email es ${data.get('email')}.`,
    ].filter(Boolean).join('\n');
    setSent(true);
    ...
    <main className="site-shell">
      ...
      <section className="hero" id="inicio">
        ...
        <div className="hero-visual" aria-label="Retrato de Laura González">
          <div className="portrait-wrap">
            <img src="/images/laura-05.jpeg" alt="Laura González, estratega digital y creadora de contenido" />
      ...
      <section className="about-section section-pad" id="sobre-mi">
        <div className="about-collage reveal">
          <div className="about-main-img"><img src="/images/laura-02.jpeg" alt="Laura González en un espacio creativo" /></div>
          <div className="about-small-img"><img src="/images/laura-01.jpeg" alt="Laura González al aire libre en Córdoba" /></div>
      ...
      <section className="journey-section section-pad" id="experiencia">
        ...
        <div className="journey-layout">
          ...
          <div className="skills-panel reveal">
            <img src="/images/laura-03.jpeg" alt="Laura González observando la ciudad de Córdoba" />
      ...
      <section className="contact-section section-pad" id="contacto">
        ...
        <div className="contact-card reveal">
          <form onSubmit={submitContact}>
            ...
            {sent && <p className="form-success" role="status"><Check />{t.sent}</p>}
          </form>
          <div className="contact-photo"><img src="/images/laura-04.jpeg" alt="Laura González" /></div>
        </div>
      </section>
